...
| [`scheduled_sync_batch_results`](#scheduled_sync_batch_results) | 預設排程同步批次中各工作的完成結果。 | 6 | 1 | 0 |
...
- [`0017_scheduled_sync_batch_membership.sql`](../packages/db/migrations/0017_scheduled_sync_batch_membership.sql)
